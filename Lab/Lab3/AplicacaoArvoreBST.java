...
public class AplicacaoArvoreBST {
    public static void main(String[] args) {
        ...
        do { 
            ...
            System.out.print("15 - Mostrar nó próximo ao nó elemento que o sucede\n");
            System.out.print("16 - Mostrar nó anterior ao nó elemento que o antecede\n");
            System.out.print("17 - Sair\n");
            ...
            switch (opcao) {
                ...
                case 15:
                    System.out.print("Digite o valor que terá seu próximo apresentado: ");
                    valor = sc.nextInt();
                    if (ar.buscar(valor) == null) {
                        System.out.print("Valor não presente na árvore");
                        break;
                    }
                    System.out.print("Próximo valor de " + valor + " é " + ar.proximo(valor));
                    break;

                case 16:
                    System.out.print("Digite o valor que terá seu anterior apresentado: ");
                    valor = sc.nextInt();
                    if (ar.buscar(valor) == null) {
                        System.out.print("Valor não presente na árvore");
                        break;
                    }
                    System.out.print("Valor do anterior de " + valor + " é " + ar.anterior(valor));
                    break;
